...
SRC_URI="x86? ( https://${PN}-downloads.s3.amazonaws.com/latest/binaries/${PN}-linux-386 -> ${P}-x86 )
	amd64?    ( https://${PN}-downloads.s3.amazonaws.com/latest/binaries/${PN}-linux-amd64 -> ${P}-amd64 )
	arm?      ( https://${PN}-downloads.s3.amazonaws.com/latest/binaries/${PN}-linux-arm -> ${P}-arm )"
